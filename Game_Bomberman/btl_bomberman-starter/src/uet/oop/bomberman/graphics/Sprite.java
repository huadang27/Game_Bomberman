...
public class Sprite {
	...
	public static Sprite item_nhay = new Sprite(DEFAULT_SIZE, 7, 10, SpriteSheet.tiles, 16, 16);
	public static Sprite item_speed = new Sprite(DEFAULT_SIZE, 2, 10, SpriteSheet.tiles, 16, 16);
	public static Sprite leverBomb = new Sprite(DEFAULT_SIZE, 1, 10, SpriteSheet.tiles, 16, 16);
